package ar.ucc.edu.arqSoftII.common.dao;
...
@Repository
public abstract class GenericDaoImp<E, ID extends Serializable> implements ar.ucc.edu.arqSoftII.common.dao.GenericDao<E, ID> {
