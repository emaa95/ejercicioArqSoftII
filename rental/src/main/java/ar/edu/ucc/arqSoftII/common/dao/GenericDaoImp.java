package ar.edu.ucc.arqSoftII.common.dao;
...
@Repository
public abstract class GenericDaoImp<E, ID extends Serializable> implements ar.edu.ucc.arqSoftII.common.dao.GenericDao<E, ID> {
